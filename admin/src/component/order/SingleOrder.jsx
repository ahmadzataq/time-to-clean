...
const SingleOrder = () => {
  ...
  useEffect(() => {
    const fatchOrder = async () => {
      const { data } = await axios.get(`https://be.timetoclean.shop/api/admin/orders/${id}`);
      setOrder(data);
      setitems(data.items);
  ...
  const submitHandler = (e) => {
    ...
    axios
      .put(`https://be.timetoclean.shop/api/admin/orders/${id}`, updateData, {
        headers: {
  ...
  const deleteHandler = () => {
    Swal.fire({
      ...
      if (result.isConfirmed) {
        axios
          .delete(`https://be.timetoclean.shop/api/admin/orders/${id}`)
          .then((response) => {
            Swal.fire({
              icon: "success",
